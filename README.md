...
4. `E` at one of the blue stalls fills the sauce bottle. Holding fire runs about a second and a half on a full bottle and gets shorter with every press after that, so the machines are where you go when the squirts stop reaching.
